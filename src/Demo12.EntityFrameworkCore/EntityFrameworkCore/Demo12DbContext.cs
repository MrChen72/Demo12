...
public class Demo12DbContext :
    AbpDbContext<Demo12DbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public Demo12DbContext(DbContextOptions<Demo12DbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(Demo12Consts.DbTablePrefix + "YourEntities", Demo12Consts.DbSchema);
